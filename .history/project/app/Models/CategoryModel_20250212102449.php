...
class CategoryModel extends BaseModel
{
    ...
    {
        $data = $this->conn->query("SELECT categories.id as category_id, categories.name as category_name, categories.desciption as category_description  FROM categories");
