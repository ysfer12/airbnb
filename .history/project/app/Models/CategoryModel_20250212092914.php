...
class CategoryModel extends BaseModel
{
    ...
    {
        $data = $this->query("SELECT categories.id as category_id, categories.name as category_name, categories.description as category_description FROM categories WHERE id = :id", ['id' => $id]);
        $data = $data->fetch();
    ...
    {
        $data = $this->connquery("SELECT categories.id as category_id, categories.name as category_name, categories.description as category_description  FROM categories");
